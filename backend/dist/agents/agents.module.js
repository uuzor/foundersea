...
const token_router_service_1 = require("./token-router.service");
...
exports.AgentsModule = AgentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [agent_service_1.AgentService, agents_service_1.AgentsService, idea_scorer_agent_1.IdeaScorerAgent, milestone_validator_agent_1.MilestoneValidatorAgent, builder_ranker_agent_1.BuilderRankerAgent, token_router_service_1.TokenRouterService],
        exports: [agent_service_1.AgentService, agents_service_1.AgentsService, token_router_service_1.TokenRouterService],
    })
], AgentsModule);
